  ...
  return (
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        My favorite recipe: how to cook a steak
        <ol id="wd-your-favorite-recipe">
          <li>Pat steak dry and let it come to room temperature.</li>
          <li>Season the steak with salt and pepper.</li>
          <li>
            Heat a pan over high heat for a couple minutes and then add oil.
          </li>
          <li>Cook the steak for 4-6 minutes on each side for medium-rare.</li>
          <li>Let the steak rest for 5 minutes before serving.</li>
        </ol>
      ...
      <div id="wd-forms">
        ...
        <form id="wd-text-fields">
          ...
          <textarea id="wd-textarea" cols={30} rows={10}>
            ...
            mauris sit amet nisl ornare accumsan non ac purus. Ut sed vehicula
            purus. Vivamus non sem tristique, faucibus urna eu, bibendum sapien.
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. In maximus
            erat et purus consequat eleifend. Suspendisse efficitur nec diam
            vitae tristique. Sed tempor ipsum sed dolor ornare, in condimentum
            tellus mattis.
          </textarea>
      ...
      <br />
      Please <a href="https://github.com/AndreiZubek/kambaz-next-js-sp26" id="wd-github">click here</a> to go to my github repository
      <br />
    </div>
  );
}
